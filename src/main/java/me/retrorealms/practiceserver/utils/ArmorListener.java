...
import me.retrorealms.practiceserver.utils.ArmorEquipEvent.EquipMethod;
 ...
 * Edited to work with our version by Kaveen K
 * 
 */
public class ArmorListener implements Listener{
	...
	public ArmorListener(PracticeServer plugin) {
		this.plugin = plugin;
