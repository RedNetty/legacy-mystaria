...
public class StaticConfig {
    ...
    public static void setup() {
        gpfile = new File(PracticeServer.plugin.getDataFolder(), "StaticPlayerConfig.yml");
    ...
    public static void save() {
        try {
            ...
            Bukkit.getServer().getLogger().severe(ChatColor.RED + "Could not save StaticPlayerConfig.yml!");
        }
    }
