...
public class AsyncTask {
	...
	/**
	 * @param task
	 *            The task you wish to be executed Async.
	 */
	...
	/**
	 * @param delay
	 *            The delay you wish your task to be ran after.
	...
	/**
	 * @param useSharedPool
	 *            Whether or not you wish to use the shared thread pool.
	 * @return The altered AsyncTask.
	 */
	...
	public void scheduleRepeatingTask() {
		if (this.useSharedThreadPool) {
			...
			Executors.newScheduledThreadPool(1).scheduleAtFixedRate(this.task, this.delay, this.interval,
					TimeUnit.SECONDS);
		}
	}
