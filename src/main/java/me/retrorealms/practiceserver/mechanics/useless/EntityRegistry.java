...
public enum EntityRegistry {
    ...
    SKELETON_BOSS("SkeletonBoss_EntityLiving", 51, EntityType.SKELETON),
    DAEMON_LORD("DaemonLord_EntityLiving", 64, EntityType.WITHER);
    ...
    EntityRegistry(String name, int id, EntityType entityType) {
        this.name = name;
        this.id = id;
    ...
    public static void registerEntities() {
        for (EntityRegistry entity : values())
            entity.registerEntity(entity.getName(), entity.getID());
    }
    ...
    private void registerEntity(String name, int id) {
        try {
