...
public class GivePickTrakCommand implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String s, String[] args){
        ...
        if(p != null && p.isOnline()){
            ...
            itemMeta.setDisplayName(ChatColor.GOLD + "Pickaxe Stat Tracker");
            ArrayList<String> lore = new ArrayList<String>();
            lore.add(ChatColor.GOLD + "Uses: " + ChatColor.GRAY + "1");
            lore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "Apply to any pickaxe to start tracking");
